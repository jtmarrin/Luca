...
//        GetRawData theRawData = new GetRawData("https://api.flickr.com/services/feeds/photos_public.gne?tags=android,lollipop&format=json&nojsoncallback=1");
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this,
            ...
            public void onItemClick(View view, int position) {
                Toast.makeText(MainActivity.this, "Long Tap To Open Image", Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(MainActivity.this, "Opening...", Toast.LENGTH_SHORT).show();
        ...
        Toast toast = Toast.makeText(MainActivity.this, "Search For PUPPIES!", Toast.LENGTH_SHORT);
...
//            });
//    }
// +++++++++++++++++++++++ look at handling runtime changes to save scroll state +++++++++++++++++++
    @Override
